...
class FileLineRepositoryImpl : FileLineRepository, KoinComponent {
    ...
    override fun getFileLinesPagedByPath(filePath: String, pageSize: Int): Flow<PagingData<String>> =
        Pager(
            config = PagingConfig(
                pageSize = pageSize,
    ...
    override fun getFileLinesPagedByContentUri(contentUriString: String, pageSize: Int): Flow<PagingData<String>> =
        Pager(
            config = PagingConfig(
                pageSize = pageSize,
                enablePlaceholders = false
